...
pub fn verify_signature(
    ...
    let sig_bytes = soroban_sdk::BytesN::<64>::from_array(env, signature.try_into().unwrap());
    let pk_bytes = soroban_sdk::BytesN::<32>::from_array(env, public_key.try_into().unwrap());
